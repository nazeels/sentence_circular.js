 //Depended libraries
 // ### touch event library ###
 //  Ref: https://github.com/mattbryson/TouchSwipe-Jquery-Plugin
 //  Implementation ref: http://www.awwwards.com/touchswipe-a-jquery-plugin-for-touch-and-gesture-based-interaction.html
 // ### Circular roation is done using CSS3 ###
 //  Ref: http://css3.bradshawenterprises.com/sliding/
 //  Implementation ref: http://jsfiddle.net/nazeels/vpGtu/8/
(function($){
  var lstSentences;
...
function seprateWords(sentance){
    var div=$('<div/>');
